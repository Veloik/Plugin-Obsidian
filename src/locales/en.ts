...
"No se ha podido leer la pizarra. El archivo original queda protegido; vuelve a abrirlo cuando esté disponible.": "Could not read the board. The original file is protected; reopen it when it is available.",
	...
	"¿Cómo insertar el libro?": "How should the book go on the board?",
	"Lector en la pizarra": "Reader on the board",
	"El libro se lee aquí mismo, capítulo a capítulo, y puedes anotar a su alrededor.": "The book is read right here, chapter by chapter, with room to write around it.",
	"Ficha del archivo": "File card",
	"Una tarjeta pequeña que abre el libro en tu lector de siempre.": "A small card that opens the book in your usual reader.",
	...
	"Capítulo {p0}": "Chapter {p0}",
	"Falta este capítulo dentro del libro.": "This chapter is missing from inside the book.",
	"El libro es demasiado grande para abrirlo en la pizarra.": "The book is too large to open on the board.",
	"Este EPUB no trae el índice que dice qué leer primero.": "This EPUB carries no index saying what to read first.",
	"Este EPUB no trae capítulos que se puedan leer.": "This EPUB carries no readable chapters.",
	"auto": "auto",
	"Lenguaje deducido del propio código. Elige otro en la barra de formato si no acierta.": "Language read off the code itself. Pick another in the format bar if it guessed wrong.",
	"Líneas largas: plegadas. Pulsa para que se desplacen.": "Long lines: folded. Press to let them scroll.",
	"Líneas largas: se desplazan. Pulsa para plegarlas.": "Long lines: scrolling. Press to fold them.",
	"Marcar esta línea": "Mark this line",
	"Quitar la marca de esta línea": "Unmark this line",
	"Marcador «{p0}». Clic para volver a esta vista": "Bookmark “{p0}”. Click to come back to this view",
	"Líneas rectas: púlsalo y todo lo que dibujes saldrá recto, como Mayús en el ordenador.": "Straight lines: switch it on and everything you draw comes out straight, like Shift on a computer.",
	"Líneas rectas activadas: todo lo que dibujes saldrá recto. Pulsa para desactivarlas.": "Straight lines are on: everything you draw comes out straight. Press to switch them off.",
	...
	"Añadir": "Add",
	"{p0} archivos añadidos a la pizarra.": "{p0} files added to the board.",
	"El dedo dibuja. Pulsa para que mueva la pizarra.": "A finger draws. Press to have it move the board.",
	"El dedo mueve la pizarra. Pulsa para dibujar con él.": "A finger moves the board. Press to draw with it.",
	...
	"Desactivado, traduce al instante con servicios gratuitos sin clave ni cuota. Actívalo para que el texto no salga de tu equipo: traduce el modelo local, que es privado pero tarda bastante más.": "Off, it translates instantly through free services with no key and no quota. Turn it on to keep your text on this computer: the local model translates it, which is private but takes considerably longer.",
	"Idiomas que usa el botón Traducir sobre el texto seleccionado.": "Languages the Translate button uses on the selected text.",
	...
	"Traducido el cuadro que estás editando": "Translated the box you are editing",
	"Traducción lista": "Translation ready",
	"traducción instantánea": "instant translation",
	...
	"Ese archivo está fuera de la bóveda, así que se pega como texto.": "That file is outside the vault, so it is pasted as text.",
	...
	"Lápiz (pulsa de nuevo: bolígrafo, lápiz, pluma, rotulador, pincel)": "Pen (press again: ballpoint, pencil, fountain, marker, brush)",
	"Edición": "Editing",
	"Deshacer / rehacer": "Undo / redo",
	"Seleccionar todo": "Select all",
	"Duplicar selección": "Duplicate selection",
	"Copiar, cortar y pegar": "Copy, cut and paste",
	"Supr": "Delete",
	"Borrar selección": "Delete selection",
	"Flechas": "Arrows",
	"Mover selección (Shift: ×10)": "Move selection (Shift: ×10)",
	"Buscar en la pizarra": "Search the board",
	"Dibujo y texto": "Drawing and text",
	"Shift + lápiz": "Shift + pen",
	...
	"Editar tabla, fórmula o gráfico": "Edit table, formula or chart",
	"Asa circular": "Round handle",
	"Girar la selección (Shift: 15°)": "Rotate the selection (Shift: 15°)",
	"Indentar en el editor": "Indent in the editor",
	"Terminar de editar": "Finish editing",
	"Fórmula LaTeX en un texto": "LaTeX formula inside text",
	"Convertir en bloque de código": "Turn into a code block",
	"Vista": "View",
	"Rueda": "Wheel",
	"Desplazar (Shift: horizontal)": "Scroll (Shift: sideways)",
	"Ctrl + rueda": "Ctrl + wheel",
	"Alt + arrastrar": "Alt + drag",
	"Mover la página": "Move the page",
	"Botón del lápiz": "Stylus button",
	"Mover la página sin cambiar de herramienta": "Move the page without changing tool",
	"Dos dedos": "Two fingers",
	"Mover la página y hacer zoom": "Move the page and zoom",
