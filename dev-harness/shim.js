...
(function () {
	...
	class Modal { constructor(app) { this.app = app; this.modalEl = document.createElement("div"); this.modalEl.className = "modal"; this.titleEl = this.modalEl.createDiv({ cls: "modal-title" }); this.contentEl = this.modalEl.createDiv({ cls: "modal-content" }); this.containerEl = document.createElement("div"); this.containerEl.className = "modal-container"; this.containerEl.appendChild(this.modalEl); } open() { document.body.appendChild(this.containerEl); this.onOpen && this.onOpen(); } close() { this.onClose && this.onClose(); this.containerEl.remove(); } setTitle(t) { this.titleEl.setText(t); return this; } }
